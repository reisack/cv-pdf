...
\cventry{Depuis 2022}{Lead Developer}{SMAG}{Montpellier}{}{Responsable technique de l'équipe, sur la partie végétale de l'ERP vendu à des coopératives
\begin{itemize}%
\item Développements d'applications frontend en VueJs 3 avec TypeScript et d'APIs Back for front en .NET 8, destinées à remplacer progressivement des écrans pour moderniser l'ERP legacy
  \begin{itemize}%
  ...
  \item Envoi par mail de contrats parcellaires en documents PDF, les PDFs sont générés à partir de rapports Reporting Services 2016
  \item Utilisation d'EF Core pour l'intéraction avec des bases de données SQL Server 2022
  \end{itemize}
...
\item Participation ponctuelle au processus de recrutement : conduite d'entretiens techniques, environ 10 candidats pour 4 recrutements réussis
\end{itemize}}
\cventry{2018--2022}{Ingénieur développement}{SMAG}{Montpellier}{}{Développements concernant la partie végétale de l'ERP agricole vendu à des coopératives
\begin{itemize}%
\item Développement ASP.NET 4.7 WebForms et T-SQL
\item Maintenance et ajout de fonctionnalités sur une application mobile basée sur le framework Ionic et utilisant Angular (TypeScript) et Cordova, concernant la gestion de parcelles agricoles
\item Mise en place de tests unitaires pour améliorer la qualité du code et réduire les anomalies
  ...
  \item Expérimentation sur l'ERP en .NET avec MSTest et la librairie Microsoft Fakes pour pouvoir mocker du code legacy, n'ayant pas l'architecture nécessaire pour écrire des tests unitaires de façon standard
  \end{itemize}
