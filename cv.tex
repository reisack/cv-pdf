...
\cventry{Depuis 2022}{Lead Developer}{SMAG}{Montpellier}{}{Responsable technique d'une équipe de 4 développeurs, sur la partie végétale de l'ERP destiné à des coopératives agricoles.
\begin{itemize}%
\item Développements et modernisation
  \begin{itemize}%
  \item Applications frontend Vue.js 3 + TypeScript et API .NET 8 (Backend For Frontend) pour remplacer progressivement certains écrans ASP.NET WebForms et ASP Classic de l'ERP
...
\item Qualité logicielle
  \begin{itemize}%
  \item Supervision et amélioration continue de la qualité des tests unitaires dans l'équipe
