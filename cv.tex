...
\cvitem{Frameworks TypeScript}{Vue (v3), PrimeVue, Angular (v9 à v18), Ionic (v5 à v8), TypeORM}
\cvitem{Tests unitaires / qualité}{NUnit, NSubstitute, Vitest, Jasmine, SonarQube}
\cvitem{Outils / plateformes}{Git, GitLab, Swagger, Microsoft Azure, OpenLens}
...
\cvitem{Intelligence artificielle}{ChatGPT (Génération de code / documentation), Windsurf (auto-complétion)}
...
\item Depuis novembre 2015 : en mission chez SMAG, éditeur de logiciel fournissant des solutions destinées au coopératives agricoles.
  ...
  \item Développement web mobile à l'aide du framework Sencha Touch 2.4, pour une coopérative souhaitant une application permettant d'assurer la transparence et la pérennité de l'approvisionement en caoutchou naturel
...
\begin{itemize}%
  \item Développements en C\# (.NET 4.0), avec l'utilisation des composants UI Telerik ASP.NET Ajax
